...
Based on the official repository's `v2.10.6-lts` (commit: [0bb81c71](https://github.com/1Panel-dev/MaxKB/commits/0bb81c71)) branch for modification, submitted 59 commits, including:
- 16 features
- 34 perf
- 09 fixes

[See the change record for details](https://github.com/wangliang181230/MaxKB/compare/0bb81c71...111efe96)

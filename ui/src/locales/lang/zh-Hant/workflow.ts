...
- 確保優化後的問題準確反映原始問題意圖，不得改變原意。`,
    ...
    a2aNode: {
      label: 'A2A 代理調用',
      text: '通過標準化協議調用其他智能體，支援子代理委派和代理團隊協作',
      agentName: 'Agent 名稱',
      agentNamePlaceholder: '請輸入子Agent的名稱',
      agentUrl: 'Agent URL',
      agentUrlPlaceholder: '請輸入Agent的API端點URL',
      protocolType: '通訊協議',
      streaming: '支援串流',
      comingSoon: '即將推出',
      collaborationMode: '協作模式',
      subagentMode: '子代理（委派式）',
      subagentTooltip: '適用於邊界清晰的單一任務委派',
      teamMode: '代理團隊（協作式）',
      teamTooltip: '適用於多角色動態協商的複雜任務',
      apiKey: 'API Key',
      apiKeyPlaceholder: '可選的身份驗證密鑰',
      advancedConfig: '高級配置',
      timeout: '超時時間（秒）',
      timeoutTip: '單個請求的最大等待時間',
      maxRetries: '最大重試次數',
      enableStreaming: '啟用串流傳輸',
      streamingTip: 'HTTP+SSE協議支援即時串流資料透傳',
      inputParams: '輸入參數',
      inputParamsTip: '配置要傳遞給子Agent的參數，點擊"添加參數"按鈕新增',
      addParam: '添加參數',
      paramKeyPrompt: '請輸入參數名稱',
      paramKeyPlaceholder: '輸入參數名...',
      paramEditTip: '按 Enter 確認，Esc 取消',
      paramExists: '該參數已存在',
      contextFields: '上下文字段',
      selectContextFields: '選擇要傳遞的上下文字段',
      contextFieldsTip: '這些字段的值將傳遞給子Agent',
      fallbackStrategy: '降級策略',
      fallbackStrategyLabel: '故障處理策略',
      fallbackErrorMessage: '返回錯誤信息',
      fallbackSkip: '跳過並繼續',
      fallbackDefaultValue: '使用預設值',
      defaultValueLabel: '預設值',
      defaultValuePlaceholder: '當Agent調用失敗時使用的預設值',
      traceId: '追蹤ID',
      responseTime: '響應時間(ms)',
      responseStatus: '響應碼',
    },
    imageGenerateNode: {
      label: '圖片生成',

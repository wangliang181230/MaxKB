...
-Ensure that the optimized problem accurately reflects the original problem intent and does not alter the original intention.`,
    ...
    a2aNode: {
      ...
      text: 'Call other agents via standardized protocols, supporting subagent delegation and agent team collaboration',
      agentName: 'Agent Name',
      agentNamePlaceholder: 'Enter the sub-agent name',
      agentUrl: 'Agent URL',
      agentUrlPlaceholder: 'Enter the agent API endpoint URL',
      protocolType: 'Communication Protocol',
      streaming: 'Streaming Support',
      comingSoon: 'Coming Soon',
      collaborationMode: 'Collaboration Mode',
      subagentMode: 'Subagent (Delegation)',
      subagentTooltip: 'Suitable for single task delegation with clear boundaries',
      teamMode: 'Agent Team (Collaboration)',
      teamTooltip: 'Suitable for complex tasks requiring multi-agent dynamic negotiation',
      apiKey: 'API Key',
      apiKeyPlaceholder: 'Optional authentication key',
      advancedConfig: 'Advanced Configuration',
      timeout: 'Timeout (seconds)',
      timeoutTip: 'Maximum wait time for a single request',
      maxRetries: 'Max Retries',
      enableStreaming: 'Enable Streaming',
      streamingTip: 'HTTP+SSE protocol supports real-time streaming data pass-through',
      inputParams: 'Input Parameters',
      inputParamsTip: 'Configure parameters to pass to the sub-agent, click "Add Parameter" to add new ones',
      addParam: 'Add Parameter',
      paramKeyPrompt: 'Enter parameter name',
      paramKeyPlaceholder: 'Enter parameter name...',
      paramEditTip: 'Press Enter to confirm, Esc to cancel',
      paramExists: 'Parameter already exists',
      contextFields: 'Context Fields',
      selectContextFields: 'Select context fields to pass',
      contextFieldsTip: 'These field values will be passed to the sub-agent',
      fallbackStrategy: 'Fallback Strategy',
      fallbackStrategyLabel: 'Failure Handling Strategy',
      fallbackErrorMessage: 'Return Error Message',
      fallbackSkip: 'Skip and Continue',
      fallbackDefaultValue: 'Use Default Value',
      defaultValueLabel: 'Default Value',
      defaultValuePlaceholder: 'Default value when agent call fails',
      traceId: 'Trace ID',

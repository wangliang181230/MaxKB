...
-Ensure that the optimized problem accurately reflects the original problem intent and does not alter the original intention.`,
    ...
    variableSplittingNode: {
      ...
      expression: {
        ...
        tooltip: 'Please use JSON Path expressions to split variables, e.g.: $.store.book <a href="https://pypi.org/project/jsonpath-ng/1.8.0/" target="_blank">Click for details (pypi.org)</a>',
      },
    },

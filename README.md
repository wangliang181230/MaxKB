...
基于官方仓库的 `v2.10.6-lts`（commit: [0bb81c71](https://github.com/1Panel-dev/MaxKB/commits/0bb81c71)） 分支进行改造的，总共提交了 59 个 Commit，包括：
- 16 个 feat
- 34 个 perf
- 09 个 fix

[详情请看变更记录](https://github.com/wangliang181230/MaxKB/compare/0bb81c71...111efe96)

...
基于官方仓库的 `v2.10.5-lts`（commit: [01b21db](https://github.com/1Panel-dev/MaxKB/commits/01b21db)） 分支进行改造的，总共提交了 56 个 Commit，包括：
- 15 个 feat
- 33 个 perf
- 08 个 fix

[详情请看变更记录](https://github.com/wangliang181230/MaxKB/compare/01b21db...4d697919)
